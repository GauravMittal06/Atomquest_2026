...
def _goals_emp1() -> list[dict]:
    ...
    return [
        ...
        _goal(gs[2], sh, ow,
              ...
              "QUANTITATIVE", "% reduction", 20.0, 20,
              checkins={
...
def _goals_emp2() -> list[dict]:
    ...
    return [
        _goal(gs[0], sh, ow,
              ...
              "QUANTITATIVE", "% reduction", 30.0, 25,
              checkins={
        ...
        _goal(gs[1], sh, ow,
              ...
              "QUANTITATIVE", "pp reduction", 5.0, 20,
              checkins={
        ...
        _goal(gs[4], sh, ow,
              ...
              "QUANTITATIVE", "% reduction", 10.0, 10,
              checkins={
        ...
        _goal(gs[5], sh, ow,
              ...
              "QUANTITATIVE", "NPS Score", 40.0, 10,
              checkins={
...
def validate(data: dict[str, list[dict]]) -> list[str]:
    ...
    for g in data[COL_GOALS]:
        wt = g["weightage"]
        if wt < 5.0 or wt > 50.0:
            errors.append(f"Goal '{g['description'][:40]}': weightage {wt} out of 5–50 range")
