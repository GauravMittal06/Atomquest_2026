/**
 * shadcn/ui-style Accordion built on @radix-ui/react-accordion.
 */
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex flex-1 items-center justify-between gap-3 py-3.5 px-5 text-left text-sm font-medium transition-all',
        'hover:bg-slate-50/80 [&[data-state=open]>svg]:rotate-180',
        className,
      )}
      {...props}
    >
